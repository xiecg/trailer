...
export default class LayoutDefault extends Component {
  ...
  matchRouteName () {
    const name = navRoutes.find(e => e.name === this.props.match.params.type) ? navRoutes.find(e => e.name === this.props.match.params.type).name : '全部';
    return this.props.match ? name : navRoutes[0].name;
  }
    ...
    return (
      <div className='flex-column' style={{ width: '100%', height: '100%' }}>
        <Menu
          ...
          mode='horizontal'
          defaultSelectedKeys={[this.matchRouteName.bind(this)]}
        >
          <Menu.Item
            style={{
              marginLeft: 24,
